...
const Header: React.FC = () => {
  return (
    <header className="sticky top-0 py-1.5 px-3 border-b border-[#D3DEDE] bg-white">
      <div className="max-w-5xl mx-auto flex items-center justify-between">
        {/* Main Logo */}
        <div className="relative w-[115px] h-12">
          <Image
        ...
        {/* Search */}
        <div
          className="hidden relative w-1/3 overflow-hidden 
          md:flex items-center rounded-full bg-[#F1F1F2] border border-transparent group focus-within:border-[#C5C6C9] 
         transition ease-in-out duration-75">
          <input
            type="text"
            placeholder="Search accounts and videos"
            className="group text-sm flex-grow py-3 pl-4 mr-11 rounded-full font-normal placeholder-gray-500 text-black bg-[#F1F1F2] focus:outline-none"
          />
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="px-8 py-2 text-sm font-bold rounded bg-[#fe2c55] hover:bg-[#EF2950] active:bg-[#DF274B] text-white transition ease-in-out duration-150">
            Log in
          </button>
